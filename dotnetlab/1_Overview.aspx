<%@ Page Title="" Language="C#" MasterPageFile="~/dotnetlab/dotnetlab.master" AutoEventWireup="true" CodeBehind="1_Overview.aspx.cs" Inherits="myPortfolio.dotnetlab.overview" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="navbar" runat="server">

    <li class="nav-item btn active rounded font-weight-bold">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="p-3">
        ...
        <div class="tab-content bg-white text-dark" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-question" role="tabpanel" aria-labelledby="nav-question-tab">
                  <div class="p-3">
                    ...
                    <li>What is CLR? Explain the Exception handling mechanism in C# with an example. [4+6]</li>
                    ...
                    <li>Differentiable between VB and VB.NET.* [4]</li>
                    </ol>
                  </div>
            </div>
